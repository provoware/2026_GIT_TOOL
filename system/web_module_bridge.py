...
MODULE_ACTIONS: dict[str, list[dict[str, Any]]] = {
    ...
    "todo_kalender": [
        ...
        _action("get_settings", "Kalenderoptionen laden"),
        _action(
            "set_legend",
            "Farblegende speichern",
            mode="write",
            fields=[_field("legend", "Fünf Farblegenden (JSON)", "json", required=True)],
        ),
        _action(
            "set_day_colors",
            "Tag farblich markieren",
            mode="write",
            fields=[
                _field("date", "Datum", "date", required=True),
                _field("color_ids", "Farben (maximal vier)", "list", required=True),
            ],
        ),
        _action(
            "add_appointment",
            ...
            fields=[
                ...
                _field("date", "Datum", "date", required=True),
                _field("all_day", "Ganztägig", "checkbox", default=False),
                _field("start_time", "Beginn", "time"),
                _field("end_time", "Ende", "time"),
                _field("location", "Ort"),
                _field("notes", "Hinweise", "textarea"),
                _field("color_id", "Farbkennung"),
                _field("reminder_minutes", "Erinnerung vorher (Minuten)", "number"),
            ],
        ),
        _action(
            "update_appointment",
            ...
            mode="write",
            fields=[
                _field("id", "Termin-ID", required=True),
                _field("title", "Titel", required=True),
                _field("date", "Datum", "date", required=True),
                _field("all_day", "Ganztägig", "checkbox", default=False),
                _field("start_time", "Beginn", "time"),
        ...
        _action(
            ...
            "Termin löschen",
            mode="write",
            fields=[_field("id", "Termin-ID", required=True)],
            confirm="Termin wirklich löschen?",
        ),
        _action("list_reminders", "Erinnerungen laden"),
        _action(
